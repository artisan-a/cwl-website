...
<body>
    ...
    <div class="contact-banner-area-start rts-section-gap mt--70">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-main-wrapper">
                        <h2 class="title split-collab">
                                Navigating Success: Your Trusted Logistics Partner
                        </h1>
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="banner-about-right">
                        <p class="disc">
                            Fluxi focus on helping you to make useful content more accessible with an ultimate goal for a good sharing profit as a content creator.
                        </p>
                        <p class="disc">
                            We see more and more ads in search results and not enough care for the people who are actually creating content.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- about large image video area end -->

    <!-- brand area start -->
    <div class="brand-area-start title-three-brand-wrapper rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="brand-area-main-wrapper-two about-page-brand">
                        <!-- Swiper -->
                        <div class="light swiper mySwiper-brand-about">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/01.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/02.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/03.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/04.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/05.svg" alt=""></a></div>
                            </div>
                        </div>
                        <!-- Swiper -->
                        <div class="dark swiper mySwiper-brand-about">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/21.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/22.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/23.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/24.svg" alt=""></a></div>
                                <div class="swiper-slide"><a href="#"><img src="assets/images/brand/21.svg" alt=""></a></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center mt--50">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        With a presence in more than 200 cities and territories, we serve all the major economies, as well as most emerging markets. 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Our customers enjoy powerful express and logistics experience using our industry-leading online tools and integrations. Our integrated network is powered by sophisticated technology and engineering systems. 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        We offer services and technology for managing the end-to-end process—from individuals to enterprises. 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        We attract and retain long-term customers by providing high-quality transportation and logistics services and expertise. 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        From our signature vehicles to our courteous and professional drivers, the Countrywide brand stands for reliability, trust, quality, and service innovation. 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        We believe that the dedication of our employees comes in large part from our distinctive "employee-owner" culture. The can-do attitude of Countrywiders is demonstrated by commitment to our customers, our communities and each other.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="thumbnail-left">
                        <img src="assets/images/working-process/04.png" alt="working-process">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- rts counter up section start3 -->
    <div class="rts-counter-up-avout-area rts-section-gap2Bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="container-counter-about-page">
                        <!-- single counter up section -->
                        <div class="single-counter-up">
                            <div class="icon">
                                <img src="assets/images/counter/11.svg" alt="counter">
                            </div>
                            <h2 class="title"><span class="counter">2017</span></h2>
                            <span class="brand-name">Year founded</span>
                        </div>
                        <!-- single counter up section end -->
                        <!-- single counter up section -->
                        <div class="single-counter-up">
                            <div class="icon">
                                <img src="assets/images/counter/12.svg" alt="counter">
                            </div>
                            <h2 class="title"><span class="counter">500</span>K</h2>
                            <span class="brand-name">Competitors keywords</span>
                        </div>
                        <!-- single counter up section end -->
                        <!-- single counter up section -->
                        <div class="single-counter-up">
                            <div class="icon">
                                <img src="assets/images/counter/13.svg" alt="counter">
                            </div>
                            <h2 class="title"><span class="counter">98</span>M</h2>
                            <span class="brand-name">Supported locations</span>
                        </div>
                        <!-- single counter up section end -->
                        <!-- single counter up section -->
                        <div class="single-counter-up">
                            <div class="icon">
                                <img src="assets/images/counter/14.svg" alt="counter">
                            </div>
                            <h2 class="title"><span class="counter">98</span>M</h2>
                            <span class="brand-name">Loyal customers</span>
                        </div>
                        <!-- single counter up section end -->
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="title-wrapper-between">
                        <div class="title-style-one-left">
                            ...
                            <h2 class="title skew-up">A full-service creative <br> digital agency</h2>
                        </div>
                        <p class="disc">
                            Fluxi agency makes it easy to create content that engages your audience by taking the guesswork out of research, strategy, and writing.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row g-48 mt--10">
                <div class="col-lg-4">
                    ...
                    <div class="rts-service-area-style-4">
                        ...
                        <p class="disc">
                            Optimizing your website for each of the main components to put a good and fit in house strategy in place.
                        </p>
                    </div>
                    <!-- service area end -->
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="rts-service-area-style-4">
                        ...
                        <p class="disc">
                            Building the site map with places to house in mind means implementing your SEO landing pages.
                        </p>
                    </div>
                    <!-- service area end -->
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="rts-service-area-style-4">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="49" height="48" viewBox="0 0 49 48" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 6H42.5C43.2957 6 44.0587 6.31607 44.6213 6.87868C45.1839 7.44129 45.5 8.20435 45.5 9V30C45.5 30.7956 45.1839 31.5587 44.6213 32.1213C44.0587 32.6839 43.2957 33 42.5 33H27.5V39H35V42H21.5V39H24.5V33H21.5V30H42.5V9H9.5V18H6.5V9C6.5 8.20435 6.81607 7.44129 7.37868 6.87868C7.94129 6.31607 8.70435 6 9.5 6ZM6.5 45H15.5C16.2956 45 17.0587 44.6839 17.6213 44.1213C18.1839 43.5587 18.5 42.7957 18.5 42V24C18.5 23.2044 18.1839 22.4413 17.6213 21.8787C17.0587 21.3161 16.2956 21 15.5 21H6.5C5.70435 21 4.94129 21.3161 4.37868 21.8787C3.81607 22.4413 3.5 23.2044 3.5 24V42C3.5 42.7957 3.81607 43.5587 4.37868 44.1213C4.94129 44.6839 5.70435 45 6.5 45ZM6.5 42V24H15.5V42H6.5Z" fill="url(#paint0_linear_1050_1443)" />
                                <defs>
                                    <linearGradient id="paint0_linear_1050_1443" x1="9.13415" y1="39.5305" x2="42.8275" y2="3.50083" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#614CE1" />
                                        <stop offset="1" stop-color="#D3CCFF" />
                                    </linearGradient>
                                </defs>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="rts-service-area-style-4">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="49" height="48" viewBox="0 0 49 48" fill="none">
                                <path d="M38.5915 36.0002C39.4874 33.8494 39.7276 31.4818 39.2817 29.195C38.8358 26.9081 37.7238 24.8041 36.0854 23.1476C36.5363 22.0118 36.6219 20.7638 36.3303 19.5771C36.0388 18.3904 35.3846 17.3241 34.4588 16.5266L38.6227 12.3627C39.1844 11.7996 39.4999 11.0367 39.4999 10.2413C39.4999 9.44585 39.1844 8.68291 38.6227 8.11981L34.3804 3.87751C33.8173 3.31559 33.0544 3 32.2589 3C31.4634 3 30.7005 3.31559 30.1375 3.87751L10.3788 23.6361C9.81715 24.1993 9.50171 24.9622 9.50171 25.7576C9.50171 26.5529 9.81715 27.3159 10.3788 27.879L14.6211 32.1213C15.1842 32.6831 15.9472 32.9986 16.7426 32.9986C17.538 32.9986 18.301 32.6831 18.864 32.1213L26.0264 24.9582C27.042 26.1334 28.48 26.8606 30.0285 26.9821C31.5769 27.1036 33.1108 26.6095 34.2972 25.6071C35.5303 27.0179 36.2876 28.7814 36.4615 30.647C36.6355 32.5127 36.2173 34.3857 35.2662 36.0002H24.5V42.0002H6.5V45.0002H42.5V36.0002H38.5915ZM16.7422 30.0002L12.5 25.7573L15.3181 22.9397L19.5605 27.1818L16.7422 30.0002ZM24.5 21.0002C24.5022 21.3791 24.5405 21.757 24.6143 22.1288L21.6817 25.0607L17.439 20.8185L32.2591 5.99851L36.5015 10.2408L31.6283 15.1145C30.7604 14.942 29.8649 14.9648 29.0069 15.1811C28.1488 15.3975 27.3496 15.8021 26.6673 16.3655C25.9849 16.9289 25.4364 17.6371 25.0616 18.4387C24.6867 19.2403 24.4949 20.1153 24.5 21.0002V21.0002ZM30.5 24.0002C29.9067 24.0002 29.3266 23.8242 28.8333 23.4946C28.3399 23.1649 27.9554 22.6964 27.7284 22.1482C27.5013 21.6 27.4419 20.9968 27.5576 20.4149C27.6734 19.8329 27.9591 19.2984 28.3787 18.8788C28.7982 18.4593 29.3328 18.1736 29.9147 18.0578C30.4967 17.942 31.0999 18.0015 31.6481 18.2285C32.1962 18.4556 32.6648 18.8401 32.9944 19.3334C33.3241 19.8268 33.5 20.4068 33.5 21.0002C33.4991 21.7955 33.1827 22.5581 32.6203 23.1205C32.0579 23.6829 31.2954 23.9992 30.5 24.0002V24.0002ZM39.5 42.0002H27.5V39.0002H39.5V42.0002Z" fill="url(#paint0_linear_1050_1740)" />
                                <defs>
                                    <linearGradient id="paint0_linear_1050_1740" x1="11.3293" y1="39.1099" x2="47.2286" y2="8.55585" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#614CE1" />
                                        <stop offset="1" stop-color="#D3CCFF" />
                                    </linearGradient>
                                </defs>
                    ...
                    <div class="single-blog-area-style-one eight-area text-center">
                        ...
                        <div class="inner-content-wrapper">
                            <div class="bottom-area mb--25">
                                <span class="admin">Jk Desani</span>
    ...
    <div class="rts-subscribe-area-one about rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
