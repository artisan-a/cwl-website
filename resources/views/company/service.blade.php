...
<body>
    ...
    <div class="rts-service-banner-area rts-section-gap inner">
        ...
        <div class="service-banner-area">
            <img src="assets/images/service/shape/01.png" alt="service" class="one">
            <img src="assets/images/service/shape/02.png" alt="service" class="two">
            <img src="assets/images/service/shape/03.png" alt="service" class="three">
    ...
    <div class="rts-product-area">
        <div class="container">
            <div class="row service-relative align-items-center section-separator-top-bg-white single-product-list  pt--125 pb--125">
                <div class="col-lg-6 col-md-6">
                    <a href="#" class="thumbnail">
                        <img src="assets/images/product/43.jpg" width="505" height="616" alt="product">
                    </a>
                </div>
                <div class="col-lg-5 col-md-6 offset-lg-1">
                    <div class="portfolio-content-wrapper-list">
                        <h3 class="pre-title">01.</h3>
                        <h2 class="title">Rail Service <br> strategy branding</h2>
                        <p class="disc">
            ...
            <div class="row service-relative align-items-center section-separator-top-bg-white single-product-list  pt--125 pb--125">
                ...
                <div class="col-lg-6 col-md-6 offset-lg-1">
                    <a href="#" class="thumbnail">
                        <img src="assets/images/product/44.jpg" width="505" height="616" alt="product">
                    </a>
                </div>
                <div class="service--shape">
            ...
            <div class="row service-relative align-items-center section-separator-top-bg-white single-product-list  pt--125 pb--125">
                <div class="col-lg-6 col-md-6">
                    <a href="#" class="thumbnail">
                        <img src="assets/images/product/45.jpg" width="505" height="616" alt="product">
                    </a>
                </div>
                <div class="col-lg-5 col-md-6 offset-lg-1">
                    <div class="portfolio-content-wrapper-list">
    ...
    <div class="rts-case-studies-4 rts-section-gap2 bg-dark-border-radious radious-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-wrapper-between">
                        <div class="title-style-one-left">
                            <span class="pre skew-up">Our featured and recent works</span>
                            <h2 class="title skew-up">Case Studies</h2>
                        </div>
            ...
            <div class="row mt--60">
                <div class="col-lg-12">
                    <div class="float-right-div-case-studies">
                        <div class="swiper mySwiper-case-4">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="siongle-portfolio-box-style style-four">
                                        ...
                                        <div class="inner-content">
                                            <div class="left-content">
                                                <span class="pre">Branding, Website</span>
                                                <a href="single-case-studies.html">
                                                    <h3 class="title animated fadeIn">Simplifi</h3>
                                                </a>
                                            </div>
                                            <div class="right">
                                                <a href="single-case-studies.html">
                                ...
                                <div class="swiper-slide">
                                    <div class="siongle-portfolio-box-style style-four">
                                        ...
                                        <div class="inner-content">
                                            <div class="left-content">
                                                <span class="pre">Website, B2B, Illustrations</span>
                                                <a href="single-case-studies.html">
                                                    <h3 class="title animated fadeIn">Discover</h3>
                                                </a>
                                            </div>
                                            <div class="right">
                                                <a href="single-case-studies.html">
    ...
    <div class="rtws-pricing-area-start-two rts-section-gap bg-light-border-radious">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-style-one-center">
                        <span class="pre skew-up">A little about us</span>
                        <h2 class="title skew-up">Unleashing the power of <br> SEO tactics</h2>
                    </div>
                </div>
            </div>
            <div class="row g-48 mt--0 justify-content-sm-center justify-content-md-start">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    ...
                    <div class="single-pricing-area-two free-place">
                        <div class="head-pricing">
                            <span class="plane_name">Free plan</span>
                        ...
                        <div class="footer">
                            <a href="#" class="rts-btn btn-primary-2">Sign up now</a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <!-- single pricing area start -->
                    <div class="single-pricing-area-two enterprise-place">
                        <div class="head-pricing">
                            <span class="plane_name">Enterprise</span>
                            <div class="doller-area">
                                <h2 class="title">$149</h2>
                                <span class="time">/ per month</span>
                            </div>
                            <p>Grow your business with ease.</p>
                        </div>
                        ...
                        <div class="footer">
                            <a href="#" class="rts-btn btn-primary-2">Let’s talk</a>
                            <p>$999 billed annually. Save $189.</p>
                        </div>
                    </div>
                    <!-- single pricing area end -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="button-text-bottom-area-pricing text-center">
                        ...
                        <a href="pricing.html" class="rts-btn btn-primary-4-border arrow-rotate">Compare all features <i class="fa-light fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="shape-area">
            <img src="assets/images/testimonials/shape/12.png" alt="shape" class="one">
            <img src="assets/images/testimonials/shape/13.png" alt="shape" class="two">
            <img src="assets/images/testimonials/shape/14.png" alt="shape" class="three">
        </div>
    </div>
    ...
    <div class="rts-faq-area-full-container style-three pt--160 pb--80">
        ...
        <div class="shape-area">
            <img src="assets/images/faq/shape/01.png" alt="sahpe" class="one">
            <img src="assets/images/faq/shape/02.png" alt="sahpe" class="two">
            <img src="assets/images/faq/shape/03.png" alt="sahpe" class="three">
            <img src="assets/images/faq/shape/04.png" alt="sahpe" class="four">
        </div>
    </div>
    ...
    <div class="rts-section-gap rts-blog-area-one style-seven about">
        <div class="container">
            ...
            <div class="row g-48 justify-content-md-start justify-content-sm-center mt--0">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    ...
                    <div class="subscribe-main-wrapper-one">
                        <div class="title-style-one-center">
                            ...
                            <div class="btn-area d-flex align-items-center justify-content-center">
                                ...
                                <a href="#" class="under-line-btn">Request a demo</a>
                            </div>
                        </div>
                        <div class="shape-area">
