...
<head>
    ...
    <title>Countrywide Logistics</title>
...
<body>
    @include('panels.header')
     <div class="main-wrapper-banner-uner-over-flew">
        <div class="rts-banner-area-two rts-section-gap">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-area-wrapper-two">
                            ...
                            <span class="bottom">Talk to an expert</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="banner-2-shape">
                <img class="one" src="assets/images/banner/short/2-shape/01.png" alt="one">
                <img class="two" src="assets/images/banner/short/2-shape/02.png" alt="one">
                <img class="three" src="assets/images/banner/short/2-shape/03.png" alt="one">
                <img class="four" src="assets/images/banner/short/2-shape/04.png" alt="one">
                <img class="five" src="assets/images/banner/short/2-shape/05.png" alt="one">
            </div>
            <div class="container rts-section-gapTop">
                <div class="row pt--120 pt_md--40 pt_sm--30">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt_sm--30">
                        <div class="brand-area-wrapper-one">
                            
                            <div class="light swiper mySwiper-brand-1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="#"><img src="assets/images/brand/01.svg" alt="brand"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#"><img src="assets/images/brand/02.svg" alt="brand"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#"><img src="assets/images/brand/03.svg" alt="brand"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#"><img src="assets/images/brand/04.svg" alt="brand"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#"><img src="assets/images/brand/05.svg" alt="brand"></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-style-one-center">
                        <span class="pre">Our main services</span>
                        <h2 class="title skew-up">Our solutions that help <br>
                            you grow up</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="single-pricing-area-start">
                        ...
                        <div class="pricing-top-area">
                            ...
                            <h6 class="title">Rail Service</h6>
                        </div>
                        <!-- pricing -top artea end -->
                        <div class="pricing-body">
                            <p class="disc">
                                Get organic traffic and high rankings with multi-team collaboration that will help you
                                optimize on-page and off-page SEO.
                            </p>
                            <div class="check-content-wrapper">
                                <!-- single check area start -->
                            ...
                            <a href="service-single.html" class="rts-btn btn-primary">Get started</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="single-pricing-area-start">
                        ...
                        <div class="pricing-top-area">
                            ...
                            <h6 class="title">Surface Service</h6>
                        </div>
                        <!-- pricing -top artea end -->
                        <div class="pricing-body">
                            <p class="disc">
